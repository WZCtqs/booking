...
@Slf4j
public class SendOrderMailUtils {
    static {
    ...
    public static void mailByAll(String smtpSever,String emailAuthentication,String sendEmail, String password,
        ...
        try {
            ...
            if (receiveEmail != null&&receiveEmail != "") {
                InternetAddress[] iaToList = new InternetAddress().parse(receiveEmail.replaceAll("，",",").replaceAll("\\|",","));
            ...
            log.error("订舱邮件发送失败：{}",m.toString(),m.getStackTrace());
        }
    }
