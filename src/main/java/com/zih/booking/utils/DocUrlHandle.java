...
public class DocUrlHandle {
    ...
    private final static String ZXDC_PLATE = "http://zxdc.zih718.com/plateform_prod_api";
    /*客户端地址替换*/
    private final static String CLIENT = "http://zxdc.zih718.com:18084";
    private final static String ZXDC = "http://zxdc.zih718.com/prod-api";
    /*箱管地址替换*/
    private final static String XG = "http://xg.zih718.com:8080";
    private final static String ZXDC_XG = "http://zxdc.zih718.com/xiangguan";
    /*大口岸地址替换*/
    private final static String DKA = "http://117.159.2.173:8088";
    private final static String ZXDC_DKA = "http://zxdc.zih718.com/dakouan";
    /*拼箱地址替换*/
    private final static String PX = "http://42.228.11.184:8080";
    private final static String ZXDC_PX = "http://zxdc.zih718.com/pinxiang";
    /*国外场站地址替换*/
    private final static String GWCZ = "http://42.228.11.184:10094";
    private final static String ZXDC_GWCZ = "http://zxdc.zih718.com/changzhan";
    /*关务地址替换*/
    private final static String GW = "http://171.8.68.70:8084";
    private final static String ZXDC_GW = "http://zxdc.zih718.com/guanwu";
    /*箱型亚欧地址替换*/
    private final static String XXYO = "http://218.28.14.176:9080";
    private final static String ZXDC_XXYO = "http://zxdc.zih718.com/xiangxingyaou";
