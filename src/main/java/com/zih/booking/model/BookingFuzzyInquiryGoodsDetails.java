 ...
 * @since 2020-01-11
 */
@TableName("booking_fuzzy_inquiry_goods_details")
public class BookingFuzzyInquiryGoodsDetails implements Serializable {
    ...
    public String toString() {
        return "BookingFuzzyInquiryGoodsDetails{" +
        "id=" + id +
        ", inquiryId=" + inquiryId +
