...
public class I18nMessageUtil {
    ...
    private static final String SUFFIX_CN = "_CN.properties";
    private static final String SUFFIX_US = "_US.properties";
    ...
    private static void initMessageSourceAccessor(String language) throws IOException {
         ...
         */
        Resource resource;
        if (language.equals(LanguageEnum.LANGUAGE_ZH_CN.getLanguage())){
            resource = resourcePatternResolver.getResource(PATH_PARENT + language + SUFFIX_CN);
        }else {
            resource = resourcePatternResolver.getResource(PATH_PARENT + language + SUFFIX_US);
        }
